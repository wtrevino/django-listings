...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field ads on 'Feed'
        db.create_table('syndication_feed_ads', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('feed', models.ForeignKey(orm['syndication.feed'], null=False)),
            ('job', models.ForeignKey(orm['listings.job'], null=False))
        ))
        db.create_unique('syndication_feed_ads', ['feed_id', 'job_id'])


    def backwards(self, orm):
        # Removing M2M table for field ads on 'Feed'
        db.delete_table('syndication_feed_ads')
    ...
    models = {
        ...
        'listings.job': {
            ...
            'ad_url': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'admin_auth': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['categories.Category']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 26, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'description_html': ('django.db.models.fields.TextField', [], {}),
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jobtype': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['listings.Type']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        'syndication.feed': {
            ...
            'ads': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['listings.Job']", 'symmetrical': 'False'}),
